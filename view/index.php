<?php include("include/doctype.php");?>
	...
	<link rel="stylesheet" href="<?php echo WEBSITE_URL; ?>css/swiper.min.css">
	<link rel="stylesheet" href="<?php echo WEBSITE_URL; ?>css/home.css">
</head>
<body>
	...
	<div class="banner">
		...
		<div class="container">
			<div class="banner__caption lang-en"> 
				<h2>Mo Sarkar</h2>
				<h3>Transparency for <span class="pink-text">Governance</span></h3>
				<p>A unique initiative for making governance more accountable and transparent with public feedback, completely transforming the way citizen services are delivered in the state.</p>
			</div>
			<div class="banner__caption lang-or"> 
				<h2>ମୋ ସରକାର</h2>
				<h3>ଶାସନରେ <span class="pink-text">ସ୍ୱଚ୍ଛତା</span></h3>
				<p>ଲୋକଙ୍କ ମତାମତ ଆଧାରରେ ଶାସନକୁ ସ୍ୱଚ୍ଛ ଓ ଉତ୍ତରଦାୟୀ କରିବା ପାଇଁ ଏକ ଅଭିନବ ପ୍ରୟାସ। ରାଜ୍ୟରେ ପ୍ରଦାନ କରାଯାଉଥିବା ସରକାରୀ ସେବାରେ ଆଣିବ ସମ୍ପୂର୍ଣ୍ଣ ପରିବର୍ତ୍ତନ।</p>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<!-- About Section -->
		<div class="about">
			<div class="about__content lang-en">
				<div class="heading">
					<h3 class="green-text">About</h3>
					<h2 class="blue-text">Mo Sarkar</h2>
				</div>
				<h4 class="gray-text italic-text">People are the soul of democracy.</h4>
				<p>Mo Sarkar is an important transformative initiative of 5-T programme which seeks to completely transform the way citizen services are delivered. Every person visiting public institutions such as hospitals, police stations etc. will be treated with dignity and his issues will be treated in a professional and ethical manner. Based on the feedback from the people, immediate action will be taken appreciating those who are doing good work and initiating action against those who are failing to deliver proper citizen services.</p>
				<a href="about-us.php" class="btn btn--grad btn--rounded">Know More</a>
			</div>
			<div class="about__content lang-or">
				<div class="heading">
					<!-- <h3 class="green-text">About</h3> -->
					<h2 class="blue-text">ମୋ ସରକାର</h2>
				</div>
				<h4 class="gray-text italic-text">ଜନସାଧାରଣ ହେଉଛନ୍ତି ଗଣତନ୍ତ୍ରର ଆତ୍ମା।</h4>
				<p>ମୁଖ୍ୟମନ୍ତ୍ରୀ ଶ୍ରୀଯୁକ୍ତ ନବୀନ ପଟ୍ଟନାୟକଙ୍କ 5T ମନ୍ତ୍ର ଉପରେ ଆଧାରିତ 'ମୋ ସରକାର' କାର୍ଯ୍ୟକ୍ରମ ଏକ ଯୁଗାନ୍ତକାରୀ ପଦକ୍ଷେପ; ଯାହାର ଉଦ୍ଦେଶ୍ୟ ଲୋକଙ୍କୁ ପ୍ରଦାନ କରାଯାଉଥିବା ସରକାରୀ ସୁବିଧାରେ ଆମୁଳଚୁଳ ପରିବର୍ତ୍ତନ ଆଣିବା। ପୋଲିସ ଷ୍ଟେସନ, ଡାକ୍ତରଖାନା ଆଦି ସରକାରୀ ଅନୁଷ୍ଠାନକୁ ଆସୁଥିବା ପ୍ରତ୍ୟେକ ବ୍ୟକ୍ତିଙ୍କୁ ଉତ୍ତମ ବ୍ୟବହାର ପ୍ରଦର୍ଶନ ସହ ବୃତ୍ତିଗତ ଏବଂ ସେବା ମନୋଭାବ ନେଇ ସେମାନଙ୍କ ସମସ୍ୟା ସମାଧାନ ହେବ। ଲୋକଙ୍କ ମତାମତ ଆଧାରରେ ଭଲ କାର୍ଯ୍ୟ କରୁଥିବା ଅଧିକାରୀଙ୍କୁ ପ୍ରଶଂସା କରାଯିବା ସହିତ ଉତ୍ତମ ସେବା ଯୋଗାଇବାରେ ବିଫଳ ହେଉଥିବା ଅଧିକାରୀଙ୍କ ବିରୋଧରେ ଦୃଢ଼ କାର୍ଯ୍ୟାନୁଷ୍ଠାନ ଗ୍ରହଣ କରାଯିବ।</p>
				<a href="about-us.php" class="btn btn--grad btn--rounded">ଅଧିକ ଜାଣନ୍ତୁ</a>
			</div>
			<div class="about__media">
				<img src="images/about-us.jpg" alt="About" class="about__media__img">
			</div>
		</div>
			...
			<div class="card">
				<div class="card__media">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51 51">
					  <path d="M34.682,44.55H30.235a1.234,1.234,0,1,0,0,2.467h4.446A1.234,1.234,0,1,0,34.682,44.55Zm44.083,0H74.319a1.234,1.234,0,1,0,0,2.467h4.446A1.234,1.234,0,1,0,78.765,44.55ZM39.772,60.491a1.237,1.237,0,0,0-1.747,0l-3.234,3.23a1.235,1.235,0,0,0,1.747,1.745l3.234-3.23A1.233,1.233,0,0,0,39.772,60.491ZM71.948,28.36a1.237,1.237,0,0,0-1.747,0L67.055,31.5A1.235,1.235,0,0,0,68.8,33.246L71.948,30.1A1.232,1.232,0,0,0,71.948,28.36Zm-30,3.139L38.8,28.36A1.235,1.235,0,0,0,37.052,30.1l3.143,3.14A1.235,1.235,0,0,0,41.943,31.5ZM74.209,63.721L70.987,60.5a1.235,1.235,0,0,0-1.747,1.745l3.222,3.217A1.235,1.235,0,0,0,74.209,63.721ZM54.5,31.349c-8.543,0-15.494,7.26-15.494,16.184a21.677,21.677,0,0,0,4.083,12.252,15.512,15.512,0,0,1,3.046,8.989v7.758A2.472,2.472,0,0,0,48.606,79H60.394a2.472,2.472,0,0,0,2.471-2.468V68.775a15.515,15.515,0,0,1,3.046-8.989,21.677,21.677,0,0,0,4.083-12.252C69.994,38.609,63.043,31.349,54.5,31.349Zm5.894,45.183H48.606V74.919H54.5a1.234,1.234,0,1,0,0-2.468H48.606V70.837H60.394v5.7h0ZM52.767,53.513l-1.652-3.525h6.77l-1.652,3.525a1.233,1.233,0,0,0-.114.441L55.161,68.369H53.839L52.881,53.954A1.233,1.233,0,0,0,52.767,53.513ZM63.9,58.354a18.05,18.05,0,0,0-3.5,10.015H57.637l0.932-14.02,2.377-5.072a1.233,1.233,0,0,0-1.119-1.756H49.173a1.233,1.233,0,0,0-1.119,1.756l2.377,5.072,0.932,14.021H48.6a18.049,18.049,0,0,0-3.5-10.015,19.435,19.435,0,0,1-3.625-10.821c0-7.563,5.842-13.716,13.023-13.716S67.523,39.97,67.523,47.533A19.429,19.429,0,0,1,63.9,58.354Z" transform="translate(-29 -28)"/>
					</svg>
				</div>
				<h3 class="card__heading">5Ts</h3>
				<p class="card__content">The principle of 5Ts is being implemented in every public service in the state today, leading to mulling of newer initiatives and measures to ensure the public receives benefits in a hassle-free manner.</p>
				<a href="about-5ts.php" class="card__link" title="">Read More</a>
			</div>
			<div class="card">
				<div class="card__media">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 56">
					  <path d="M105,74l-3.931,8.133s-0.425,1.59.943,1.783,7.861,0,7.861,0l3.773-4.647L111,78l-0.184.675-2.2,2.864h-4.088l3.145-5.053S105,74.694,105,74Zm29,1,3.932,7.067s0.422,1.575-.939,1.767-7.817,0-7.817,0L126,79h2V78l2.427,3.478h4.065l-2.973-4.62C131.775,77.5,134.048,75.808,134,75Zm1.09-24.137a1.227,1.227,0,1,0-2.282.9,13.471,13.471,0,1,1-7.571-7.575,1.227,1.227,0,1,0,.907-2.28A15.909,15.909,0,1,0,135.09,50.863Zm7.563-.561a1.227,1.227,0,1,0-2.359.675A20.8,20.8,0,1,1,126.026,36.7a1.227,1.227,0,0,0,.677-2.359A23.262,23.262,0,1,0,142.653,50.3Zm-13.835,5.668a1.227,1.227,0,1,0-2.444.218c0.015,0.175.023,0.353,0.023,0.531a6.123,6.123,0,1,1-6.121-6.125c0.188,0,.373.008,0.549,0.024a1.227,1.227,0,0,0,.225-2.444c-0.25-.023-0.511-0.035-0.774-0.035a8.578,8.578,0,1,0,8.575,8.579C128.851,56.47,128.84,56.217,128.818,55.971ZM148.812,36.25a2.446,2.446,0,0,0-2.267-1.515h-4.278V30.456a2.454,2.454,0,0,0-4.189-1.736l-7.147,7.149a3.656,3.656,0,0,0-1.078,2.6v6.944l-9.97,9.973a1.227,1.227,0,1,0,1.735,1.735l9.97-9.973h6.943a3.656,3.656,0,0,0,2.6-1.078l7.147-7.149A2.444,2.444,0,0,0,148.812,36.25Zm-16.505,2.222a1.22,1.22,0,0,1,.359-0.867l7.148-7.148v5l-7.507,7.508v-4.49h0Zm7.091,5.866a1.235,1.235,0,0,1-.867.359h-4.489l7.507-7.508h5Z" transform="translate(-97 -28)"/>
					</svg>
				</div>
				<h3 class="card__heading">Mission</h3>
				<p class="card__content">In order to know whether citizens are satisfied with service delivery it is imperative to assess the feedback on the services delivered by the government institutions.  </p>
				<a href="#!" class="card__link" title="">Read More</a>
			</div>
			<div class="card">
				<div class="card__media">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 62 46">
					  <path d="M223.751,60.737C223.4,60.258,215.1,49,204.5,49s-18.9,11.258-19.252,11.737a1.3,1.3,0,0,0,0,1.526C185.6,62.742,193.9,74,204.5,74s18.9-11.258,19.252-11.737A1.3,1.3,0,0,0,223.751,60.737ZM204.5,71.414c-7.81,0-14.574-7.472-16.576-9.915,2-2.445,8.749-9.913,16.576-9.913,7.809,0,14.572,7.471,16.576,9.915C219.075,63.946,212.325,71.414,204.5,71.414Zm0-17.673a7.759,7.759,0,1,0,7.714,7.759A7.746,7.746,0,0,0,204.5,53.741Zm0,12.931a5.172,5.172,0,1,1,5.142-5.172A5.163,5.163,0,0,1,204.5,66.672ZM174,54V42a3.84,3.84,0,0,1,4-4h18v3H179a1.754,1.754,0,0,0-2,2V54h-3Zm62,0V42a3.84,3.84,0,0,0-4-4H214v3h17a1.754,1.754,0,0,1,2,2V54h3ZM174,68V80a3.84,3.84,0,0,0,4,4h18V81H179a1.754,1.754,0,0,1-2-2V68h-3Zm62,0V80a3.84,3.84,0,0,1-4,4H214V81h17a1.754,1.754,0,0,0,2-2V68h3Z" transform="translate(-174 -38)"/>
					</svg>
				</div>
				<h3 class="card__heading">Vision</h3>
				<p class="card__content">Under ‘Mo Sarkar’ people are the masters and those who work here are paid by the people. It seeks a complete transformation in the way government services are delivered.</p>
				<a href="#!" class="card__link" title="">Read More</a>
			</div>
		</div>
	</div><!-- container -->
	...
	<!-- Density -->
    <div class="density">
    <div class="container conatiner_density">
    <div class="heading lang-en">
				<h3 class="green-text">Call</h3>
				<h2 class="blue-text">Density</h2>
			</div>
     <div class="density__mapbody">
     <div class="mapText_density">
   
     <h1><small>Home</small>224567</h1>
     <hr>
...
<a href="javascript:void(0);" target="_blank" id ="link-20">
...
<a href="javascript:void(0);" target="_blank" id ="link-17">
...
<a href="javascript:void(0);" target="_blank" id ="link-23">
...
<a href="javascript:void(0);" target="_blank" id ="link-4">
...
<a href="javascript:void(0);" target="_blank" id ="link-6">
...
<a href="javascript:void(0);" target="_blank" id ="link-14">
...
<a href="javascript:void(0);" target="_blank" id ="link-10">
...
<a href="javascript:void(0);" target="_blank" id ="link-8">
...
<a href="javascript:void(0);" target="_blank" id ="link-13">
...
<a href="javascript:void(0);" target="_blank" id ="link-18">
...
<a href="javascript:void(0);" target="_blank" id ="link-15">
...
<a href="javascript:void(0);" target="_blank" id ="link-31">
...
<a href="javascript:void(0);" target="_blank" id ="link-5">
...
<a href="javascript:void(0);" target="_blank" id ="link-30">
...
<a href="javascript:void(0);" target="_blank" id ="link-3">
...
<a href="javascript:void(0);" target="_blank" id ="link-16">
...
<a href="javascript:void(0);" target="_blank" id ="link-7">
...
<a href="javascript:void(0);" target="_blank" id ="link-26">
<path class="st0 dist-block"  id="26" name="nuapada" style="cursor:pointer;"  d="M102.3,166h-0.9v-0.8l-0.8,0.8l0.2,3.4l-0.9,0.9l0.9,1.7l0.3,13.8l1.7,1.7l0.1,6.7l-0.8,0.9l0.1,2.3h-0.8
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-24">
<path class="st0 dist-block"  id="24" name="nabarangpur" style="cursor:pointer;"  d="M63.2,244.4h-2.3v0.8H60l-1.6,1.6l-0.8,1.7l-0.9,0.8h-1.4l-0.9,0.9l0.1,2.5l-0.8,0.8v1.6L53,256v1.6l-0.8,0.9
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-21">
<path class="st0 dist-block"  id="21" name="koraput" style="cursor:pointer;"  d="M89.7,342.5l-0.7-0.1l0.7,0.9l0.1,2.5l-0.7,0.8l2.4,5.1l0.2,7.4h0.9l0.1,3.2H91l-1.5-0.8h-1.7l-1.6,0.8
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-22">
<path class="st0 dist-block"  id="22" name="malkangiri" style="cursor:pointer;"  d="M59.1,397.5l0.8,0.9l0.1,0.8h-1.6l-0.8,0.9h-0.8l-0.9,0.6h-0.8v1.8l-0.8,0.8v0.9h-0.7l-3.3,3.3l-1.6,0.8
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-28">
...
<g>
  <g>
    <g>
      <a href="javascript:void(0);" target="_blank" id ="link-29">
...
<a href="javascript:void(0);" target="_blank" id ="link-9">
<path class="st0 dist-block"  id="9" name="debgarh"  style="cursor:pointer;"  d="M321.6,84.4l-0.8,0.4l0.9,1.3l-0.5,1l-1.3,0.3c0,0-1,0.6-1.1,0.6s-4.7,0-4.7,0l-1.7,1.7l-4.1,0.1l-0.8-0.9v0.8
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-12">
<path  class="st0 dist-block"  id="12" name="ganjam"  style="cursor:pointer;"  d="M288.5,298l1.1,0.1v0.8v0.8h0.8h1.6l0.8-0.8v-0.8l1.6-1.6v-0.8l0.9-0.9v0.8l0.9,0.8l0.1,0.8h5.8v0.8h0.8
 ...
 <a href="javascript:void(0);" target="_blank" id ="link-11"> 
<path class="st0 dist-block"  id="11" name="gajapati"  style="cursor:pointer;"  d="M244.3,356.4l2.1-2.4h0.9v-0.8l0.8-0.7l1.6-0.9v0.8l0.9,0.8h0.9v0.8l0.8,0.9l0.8,0.1l1.7,1.6l2.5-0.1l-0.1-2.6
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-27">
<path class="st0 dist-block"  id="27" name="Puri"  style="cursor:pointer;"  d="M468,245.2l-1.3,0.1l-1.7,0.9l-0.8-0.9h-4l-0.9-0.8h-0.9l-0.6,0.8h-0.9v0.9l-1.6-0.2l-0.1-2.5l-1.6,0.1
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-25">
<path class="st0 dist-block"  id="25" name="nayagarh"  style="cursor:pointer;"  d="M333.2,204.2l-0.7,0.9v0.8l-0.8,1.6l-0.8,2.5l-0.8,0.8l0.9,0.9l0.9,1.6H331l-0.8,0.8h-0.9l-0.8,0.9h-4.1
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-19">
<path class="st1 dist-block block-kj"  id="19" name="keonJhar"  style="cursor:pointer;"  d="M491.7,133.9V133h0.7l0.8-0.7h-0.9v-0.8l-0.7-0.9v-0.8h-0.9l-0.1-2.4v-0.9l0.9-0.8l-0.1-0.8l-0.9-1v-0.7h-0.8
  ...
  <a href="javascript:void(0);" target="_blank" id ="link-2">
...
<!-- Process -->
	<div class="process">
		<div class="container">
			<div class="heading lang-en">
				<h3 class="green-text">HOW DOES IT WORK</h3>
				<h2 class="blue-text">Mo Sarkar For Governance</h2>
			</div>
			<div class="heading lang-or">
				<h3 class="green-text">ଏହାର କାର୍ଯ୍ୟ ପ୍ରଣାଳୀ</h3>
				<h2 class="blue-text">Mo Sarkar For Governance</h2>
			</div>
        ...
        <div class="process_card">
			 ...
			 <img src="images/Public.png">
				...
				<p class="card__content__process">Public</p>				
			</div>
			   ...
			   <div class="process_card">
				...
				<p class="card__content__process">Police Stations/District Headquarters Hospitals - Registration on Mo Sarkar Portal</p>				
			</div>
			   <div class="process_card">
				<div class="card__process">
		            <img src="images/mosarkarportal.png">
				</div>				
				<p class="card__content__process">Mo Sarkar Portal - Acknowledgement SMS sent to complainant</p>				
			</div>
			   <div class="process_card">
				<div class="card__process">
		         <img src="images/Chat.png">
				</div>				
				<p class="card__content__process">Chief Minister Directly connect to Chief Minister  <br><small>(For any ten complainants)</small>	</p>	
               		
			</div>
			
                </div>

				<!--<img src="images/process-flow-mob.png" alt="process">
				<img src="images/process-flow-desktop.png" alt="process">-->
			</div>
			<div class="process__media lang-or">
				<!--<img src="images/process-flow-mob-odia.png" alt="process">
				<img src="images/process-flow-desktop-odia.png" alt="process">-->
			</div>

			<div class="cta-btn">
				<a href="tel:14545" title="Click to Call" class="btn--rounded">
					<svg xmlns="http://www.w3.org/2000/svg" width="65.469" height="65.313" viewBox="0 0 65.469 65.313">
					  <path d="M101,35s6.712-7.383,10-6,5.878,9.284,5,11-5.788,4.284-5,8,7.212,12.951,10,12,3.712-2.383,6-3c0,0,2.378-1.383,7,2s5.045,8.951-7,13c0,0-6.788,1.784-14-6S100.712,51.617,99,43C99,43,98.333,37.833,101,35Zm4-4s3.522,13.279,7,14c0.288,0.06,1-2,1-2l-6-13Zm18,28s8.321,11.142,10,10c0.111-.076,2-1,2-1s-7.962-8.526-10-10C124.95,57.964,123,59,123,59Zm7,12s6.6-.5,4,3-8.112,7.214-20,6S84.317,68.643,89,44c0,0,5.174-19.643,28-21,0,0,20.46-.643,26,19,0,0,2.46,6.786,1,17,0,0,.745,3.5,4,1s4.031-39.5-31-41c0,0-32.54-1.071-33,34,0,0-.54,24.357,25,31,0,0,21.46,3.071,30-10,0,0,7.46-4.071-4-6A45.267,45.267,0,0,1,130,71Z" transform="translate(-84 -19)"/>
					</svg>
					<div class="cta-btn__text lang-en">
						<span>Call Us</span>
						<span>14545</span>
					</div>
					<div class="cta-btn__text lang-or">
						<span>ଫୋନ କରନ୍ତୁ</span>
						<span>୧୪୫୪୫</span>
					</div>
				</a>
			</div>
...
<!-- Process -->
	...
	<div class="container">
		<div class="social-grid">
				...
				<div class="swiper-container">
				    <div class="swiper-wrapper">
				      <div class="swiper-slide">
				      	...
				      	<div class="slider__content lang-en">
				      		<span class="slider__label btn--grad">News</span>
				      		<h3 class="item__heading">CM announces Mo Sarkar</h3>
				      		<span class="item__date">28th Sep 2019</span>
				      		<p class="item__desc">Chief Minister Shri Naveen Patnaik announced a new initiative called ‘Mo Sarkar’ during his Independence Day speech. The programme follows the mantra of 5Ts for enhancing public service delivery in the state.</p>
				      		<!-- <a href="#!" title="" class="item__link">Read More</a> -->
				      	</div>
				      	<div class="slider__content lang-or">
				      		<span class="slider__label btn--grad">ଖବର</span>
				      		<h3 class="item__heading">CM announces Mo Sarkar</h3>
				      		<span class="item__date">28th Sep 2019</span>
				      		<p class="item__desc">Chief Minister Shri Naveen Patnaik announced a new initiative called ‘Mo Sarkar’ during his Independence Day speech. The programme follows the mantra of 5Ts for enhancing public service delivery in the state.</p>
				      		<!-- <a href="#!" title="" class="item__link">Read More</a> -->
			...
			<div class="social__video">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/aCZb3PwEutw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
			</div>
			<div class="event-slider">
				<div class="swiper-container">
				    <div class="swiper-wrapper">
				      <div class="swiper-slide">
				      	<div class="slider__media">
				      		<img src="images/event1.jpg" alt="news">
				      	</div>
				      	<div class="slider__content lang-en">
				      		<span class="slider__label btn--grad">Event</span>
				      		<h3 class="item__heading">Chief Minister addresses RTOs on Mo Sarkar </h3>
				      		<span class="item__date">28th Sep 2019</span>
				      		<p class="item__desc">Chief Minister Shri Naveen Patnaik addressed all RTOs in the state on improving facilitation of various public services, on par with the principles of 5Ts. </p>
				      		<!-- <a href="#!" title="" class="item__link">Read More</a> -->
				      		
				      	</div>
				      	<div class="slider__content lang-or">
				      		<span class="slider__label btn--grad">କାର୍ଯ୍ୟକ୍ରମ</span>
				      		<h3 class="item__heading">Chief Minister addresses RTOs on Mo Sarkar </h3>
				      		<span class="item__date">28th Sep 2019</span>
				      		<p class="item__desc">Chief Minister Shri Naveen Patnaik addressed all RTOs in the state on improving facilitation of various public services, on par with the principles of 5Ts. </p>
				      		<!-- <a href="#!" title="" class="item__link">Read More</a> -->
			...
			<div class="social__feed">
				<a class="twitter-timeline" href="https://twitter.com/MoSarkar5t?ref_src=twsrc%5Etfw">Tweets by CSMTechnologies</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
			</div>
		</div>
	</div>
	...
	<script src="<?php echo WEBSITE_URL; ?>js/swiper.min.js"></script>
	<script src="<?php echo WEBSITE_URL; ?>js/home.js"></script>
	<script src="<?php echo WEBSITE_APPURL;?>js/jquery.blockUI.js"></script> 
	<script>
