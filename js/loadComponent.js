...
// *** Script for get Absolute path and Updated by Sudam Chandra Panda on 28th Jun 2012 ****//
	...
	var URL			= "http://"+host+"/"+FN1+"/App";
	var siteUrl 	= "http://"+host+"/"+FN1+"/App";
	var splArr 		= [ "'", "<", ">", "%", "--" ];
	...
	function PrintPage() {
		 ...
		 cloneTable.find('a').each(function(){
			...
			//wWinPrint.document.write("<div id='header'><div class='pull-left text_logo'><h1 class='logo'>CMO<br /><span>Government of Odisha</span></h1></div><div class='clear'>&nbsp;</div></div>")
                        wWinPrint.document.write("<div id='header'><div class='pull-left text_logo'><img src='"+URL+"/images/logo.png' style='width:200px;' /></div><button type='button' onClick='window.print();' class='btn btn-success noPrint'>Print</button><div class='clear'>&nbsp;</div></div>")
