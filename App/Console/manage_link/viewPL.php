...
/* ================================================
	...
	includes			  : viewPLInner.php,header.php,leftmenu.php,navigation.php,title.php,util.php,footer.php

	==================================================*/
	require("viewPLInner.php");
?>
                ...
                <td valign="top"><div id="ContArea">
                    ...
                    <div class="MyTab">
                      <ul class="nav nav-tabs">
                        <li><a href="<?php echo $strPath;?>addPL/<?php echo $glId;?>/<?php echo $plId;?>" title="Add">Add</a></li>
                    ...
                    <div class="searchpanel" id="searchPanel">
                      <table border="0" cellspacing="0" cellpadding="0">
                        <tr>						  
						  <td>Select Global link</td>
                          <td>
						  <select name="selGL" id="selGL" style="width:120px;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
							...
							<?php
								while($row	= mysqli_fetch_array($result))
								{
									...
									if($row['INT_STATUS']==1)
									{
										...
										$text		= "Active";
										$readOnly	= "";
										$strEdit	= "<a href='".$strPath.'addPL/'.$glId.'/'.$plId.'/'.$row['INT_PL_ID'].'/'.$intPgno.'/'.$intRecno."'  title='Edit' class='btn btn-info'><i class='icon-white icon-edit'></i></a>";										
							...
							?>
							  <tr class="<?php echo $actbgColor;?>">
							    ...
							    <input name="hdnId<?php echo $intCount;?>" id="hdnId<?php echo $intCount;?>" type="hidden" value="<?php echo $row['INT_PL_ID'];?>" />                         		</td>
                                <td><input type="text" onkeypress="return isNumberKey(event);" name="txtSLNo<?php echo $row['INT_PL_ID'];?>" id="txtSLNo<?php echo $row['INT_PL_ID'];?>" value="<?php echo $row['INT_SL_NO'];?>" style="width:72%" maxlength="5" <?php echo $readOnly;?> /></td>                                
                                <td><?php echo $row['VCH_PL_NAME'];?></td>
                                <td>
								<?php 
                                ...
                                <td>
									<?php 
										if($row['INT_LINK_TYPE']==1)
											echo 'Internal';
										else if($row['INT_LINK_TYPE']==2)
											echo 'External';
									?>								</td>
								<td>
								<?php 
									
									echo ($row['INT_LINK_TYPE']==1)?$obj->getName('VCH_FUN_NAME','m_admin_function_master','INT_FUN_ID',$row['VCH_FUNC_FILE'],'BIT_DELETED_FLAG'):$row['VCH_FUNC_FILE'];
								?></td>
								<td>
								<?php 
