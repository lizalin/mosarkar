<?php 
/* ================================================
	File Name         	  : viewButton.php
	Description			  : This page is used to View the Button master.
	Author Name			  : Sunil Kumar Parida
	Date Created		  : 13 Sept 2013
	Designed By			  :	
    Designed On			  :	
	Update History		  :
						<Updated by>			<Updated On>		<Remarks>						
	Style sheet           : style.css,bootstrap.css                                             
	includes			  : viewButtonInner.php,header.php,leftmenu.php,navigation.php,title.php,util.php,footer.php

	==================================================*/
	require("viewButtonInner.php");
?>
                ...
                <td valign="top"><div id="ContArea">
                    ...
                    <div class="MyTab">
                      <ul class="nav nav-tabs">
                        <li><a href="<?php echo $strPath;?>addButton/<?php echo $glId;?>/<?php echo $plId;?>" title="Add">Add</a></li>
                    ...
                    <div class="searchpanel" id="searchPanel">
                      <table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td>
						  <select name="selFunction" id="selFunction" style="width:120px;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
							...
							<?php
								while($row	= mysqli_fetch_array($result))
								{
									...
									if($row['INT_STATUS']==1)
									{
										...
										$text		= "Active";
										$readOnly	= "";
										$strEdit	= "<a href='".$strPath.'addButton/'.$glId.'/'.$plId.'/'.$row['INT_BTN_ID'].'/'.$intPgno.'/'.$intRecno."'  title='Edit' class='btn btn-info'><i class='icon-white icon-edit'></i></a>";
							...
							?>
							  <tr class="<?php echo $actbgColor;?>">
							    ...
							    <input name="hdnId<?php echo $intCount;?>" id="hdnId<?php echo $intCount;?>" type="hidden" value="<?php echo $row['INT_BTN_ID'];?>" />                         		</td>
                                <td>
								<input type="text" onkeypress="return isNumberKey(event);" name="txtSLNo<?php echo $row['INT_BTN_ID'];?>" id="txtSLNo<?php echo $row['INT_BTN_ID'];?>" value="<?php echo $row['INT_SL_NO'];?>" style="width:72%" maxlength="5" <?php echo $readOnly;?> />
								</td>                                
                                <td><?php echo $row['VCH_BUTTON_NAME'];?></td>                                
