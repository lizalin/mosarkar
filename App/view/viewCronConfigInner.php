...
//        exit;
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
	{
        ...
        if($isPaging==0)
            ...
            $result		= $objCron->viewData('PG',$intRecno,$selJobType,$jobName,$userId,'','',0,0,'','','0000-00-00');

       else
	{
      $intPgno	= 1;
      $intRecno	= 0;
      $result                      = $objCron->viewData('V',0,$selJobType,$txtJobName,$userId,'','',0,0,'','','0000-00-00');
	}
      $totalResult                 = $objCron->viewData('CT',0,$selJobType,$txtJobName,$userId,'','',0,0,'','','0000-00-00'); 
