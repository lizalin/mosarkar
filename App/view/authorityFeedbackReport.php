                  ...
                  <div class="title-details">
                   ...
                   <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">Authority Feedback Report</li>
                        </ol>
                     </nav>
               </div>
               <div class="row">
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active"  href="javascript:void(0)">Authority Feedback Report</a>
                           </ul>
                            ...
                            <?php if ($result->num_rows > 0) {   $ctr = 1;  ?>
                              ...
                              <table data-toggle="table" class="table table-hover table-bordered" id="dataTable">
                                 <thead>
                                    <tr>
                                       ...
                                       <th colspan="5" class="text-center">Completed Call Feedback</th>
                                    </tr>
                                    <tr>
                                      <th>Bad</th>
                                      <th>Poor</th>
                              ...
                              <?php
                                    ...
                                    <tr>
                                      ...
                                      <td class="text-right"><a  title="" data-original-title="View" href="javascript:void(0);"><span class="badge badge-primary"><?php echo $arrRecords['vchReceived'] ;?></span></a></td>

                                      
                                      <!-- <td class="text-right"><?php //echo $arrRecords['vchReceived'] ;?></td> -->
                                       <td class="text-right"> <a  title="" data-original-title="View" href="javascript:void(0);"><span class="badge badge-danger"><?php echo $arrRecords['vchBad'] ;?></span></a></td>

                                      <td class="text-right"> <a  title="" data-original-title="View" href="javascript:void(0);"><span class="badge badge-rejected"><?php echo $arrRecords['vchPoor'] ;?></span></a></td>

                                      <!-- <td class="text-right"><?php //echo $arrRecords['vchPoor'] ;?></td> -->
                                      <td class="text-right"> <a  title="" data-original-title="View" href="javascript:void(0);"><span class="badge badge-warning"><?php echo $arrRecords['vchAverage'] ;?></span></a></td>
                                      <!-- <td class="text-right"><?php //echo $arrRecords['vchAverage'] ;?></td> -->
                                      <td class="text-right"> <a  title="" data-original-title="View" href="javascript:void(0);"><span class="badge badge-unreachable"><?php echo $arrRecords['vchGood'] ;?></span></a></td>

                                       <td class="text-right"> <a  title="" data-original-title="View" href="javascript:void(0);"><span class="badge badge-success"><?php echo $arrRecords['vchOutstanding'] ;?></span></a></td>
                                  ...
                                  <tr>
                                    ...
                                    <!-- <th class="text-right"><?php //echo $totalToBeUpdate ?></th> -->
                                  </tr>
                              </table>
