                  ...
                  <div class="title-details">
                   ...
                   <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">Outbound Call CC MIS Report</li>
                        </ol>
                     </nav>
               </div>
               <div class="row">
                     ...
                     <div class="card">
                        <div class="card-header">
                           <ul class="nav nav-tabs nav-fill" role="tablist">
                              ...
                              <a class="nav-item nav-link active"  href="javascript:void(0)">Outbound Call CC MIS Report</a>
                           </ul>
                            ...
                            <?php if ($result->num_rows > 0) {   $ctr = 1;  ?>
                              ...
                              <table data-toggle="table" class="table table-hover table-bordered" id="dataTable" >
                                 <thead>
                                    <tr>
                                       ...
                                       <th colspan="9" class="text-center">Not Connected</th>
                                    </tr>
                                    <tr>
                                      <th>Not Reachable</th>
                              ...
                              <?php
                                    ...
                                    <tr>
                                     ...
                                     <td class="text-right"><!-- <a  title="" data-original-title="View" href="<?php echo APPURL;?>viewOutBoundDetails<?php echo($intId); ?>"> --><span class="badge badge-primary"><?php echo $arrRecords['vchTotal'] ;?></span><!-- </a> --></td>
                                      ...
                                      <td class="text-right"><span class="badge badge-unintrested"><?php echo $arrRecords['vchNotWantToTalk'] ;?></span></td>
                                      <td class="text-right"><span class="badge badge-info"><?php echo $arrRecords['vchGovtServant'] ;?></span></td>
                                      <td class="text-right"><span class="badge badge-callater"><?php echo $arrRecords['vchCallLeter'] ;?></span></td>
                                      ...
                                      <td class="text-right"><span class="badge badge-notrecieved"><?php echo $arrRecords['vchNotVisited'] ;?></span></td>
                                    </tr>
                                   ...
                                   <?php 
                                    ...
                                    $totalNotWanted     =$totalNotWanted +$arrRecords['vchNotWantToTalk']  ;
                                    $totalDND           =$totalDND + $arrRecords['vchGovtServant'] ;
                                    $totalCallLatter    =$totalCallLatter +$arrRecords['vchCallLeter']  ;
