...
//print_r($deletePriv);exit;
	...
	if(isset($_REQUEST['hdn_qs'])&& $_REQUEST['hdn_qs']!='' )
        ...
        if($isPaging==0){
             $result        = $obj->viewServices('PG',$intRecno,$vchDepartmentId,$vchServiceName);
        }     
    else
    {
            $intPgno    = 1;
            $intRecno   = 0;
            $result                 = $obj->viewServices('V',$intRecno,$vchDepartmentId,$vchServiceName);
    }
       $totalResult                 = $obj->viewServices('V',$intRecno,$vchDepartmentId,$vchServiceName);
