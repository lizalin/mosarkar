<?php 
   ...
   // print_r($homeDecrpt);exit;
    $dataArr            =array();
    $type               =  !empty($homeDecrpt['type'])?$homeDecrpt['type']:1 ;
    $vchDepartmentId = !empty($homeDecrpt['intDepartmentId'])?$homeDecrpt['intDepartmentId']:0 ;
...
// print_r($_REQUEST['ID']);exit;
    ...
    if($isPaging==0 && $_REQUEST['hdn_PageNo']=='' && $_REQUEST['ID']>0)
    {
     ...
     $openFlag   = (($vchDepartmentId>0)|| ($vchServiceName!='') || ($district!='')) ? 'S' :'';
