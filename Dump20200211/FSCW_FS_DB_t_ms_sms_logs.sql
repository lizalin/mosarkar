...
--
-- Table structure for table `t_ms_sms_logs`
--

DROP TABLE IF EXISTS `t_ms_sms_logs`;
...
--
-- Dumping data for table `t_ms_sms_logs`
--

LOCK TABLES `t_ms_sms_logs` WRITE;
/*!40000 ALTER TABLE `t_ms_sms_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_ms_sms_logs` ENABLE KEYS */;
UNLOCK TABLES;
